-- =====================================================
-- Script de correction: RLS INSERT pour conversation_members
-- Date: 2025-01-28
-- Description: Permet aux fonctions SECURITY DEFINER d'ajouter des membres
--              aux conversations créées par ces fonctions
-- 
-- PROBLÈME CORRIGÉ:
-- Les fonctions SECURITY DEFINER ne peuvent pas ajouter des membres
-- car la politique vérifie que created_by = auth.uid()
-- =====================================================
...
BEGIN
  ...
  RAISE NOTICE 'Les fonctions SECURITY DEFINER peuvent maintenant ajouter des membres';
END $$;
