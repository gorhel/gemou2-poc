    ...
    Tables: {
      ...
      user_settings: {
        Row: {
          ...
          games_collection_visibility: string;
          ...
          notify_events_inapp: boolean;
          notify_events_push: boolean;
          notify_events_email: boolean;
          notify_event_invitations_inapp: boolean;
          notify_event_invitations_push: boolean;
          notify_event_invitations_email: boolean;
          notify_event_reminders_inapp: boolean;
          notify_event_reminders_push: boolean;
          notify_event_reminders_email: boolean;
          notify_event_updates_inapp: boolean;
          notify_event_updates_push: boolean;
          notify_event_updates_email: boolean;
          notify_messages_inapp: boolean;
          notify_messages_push: boolean;
          notify_messages_email: boolean;
          notify_message_replies_inapp: boolean;
          notify_message_replies_push: boolean;
          notify_message_replies_email: boolean;
          notify_message_mentions_inapp: boolean;
          notify_message_mentions_push: boolean;
          notify_message_mentions_email: boolean;
          notify_activity_comments_inapp: boolean;
          notify_activity_comments_push: boolean;
          notify_activity_comments_email: boolean;
          notify_activity_reviews_inapp: boolean;
          notify_activity_reviews_push: boolean;
          notify_activity_reviews_email: boolean;
          notify_activity_games_added_inapp: boolean;
          notify_activity_games_added_push: boolean;
          notify_activity_games_added_email: boolean;
          notify_marketplace_new_offers_inapp: boolean;
          notify_marketplace_new_offers_push: boolean;
          notify_marketplace_new_offers_email: boolean;
          notify_marketplace_messages_inapp: boolean;
          notify_marketplace_messages_push: boolean;
          notify_marketplace_messages_email: boolean;
          language: string;
          timezone: string;
          date_format: string;
