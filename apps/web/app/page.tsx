...
export default function Home() {
  ...
  // Redirection automatique vers l'onboarding si pas encore vu
  ...
  // Si l'onboarding n'a pas été vu, afficher un écran de chargement
  if (!hasSeenOnboarding) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-primary-50 to-secondary-50 flex items-center justify-center">
        <div className="text-center">
          <LoadingSpinner size="xl" className="mb-4" />
          <p className="text-gray-600 text-lg">Redirection vers l'onboarding...</p>
        </div>
      </div>
    );
  }

  // Affichage normal après onboarding
  if (user) {
    return <Dashboard />;
  }
