...
export default function EventPageOptimized() {
  ...
  // Utiliser le hook pour gérer les participants
  const {
    participants,
    ...
    onError: (error) => console.error('Erreur participants:', error)
  });
  ...
  const handleJoinEvent = async () => {
    try {
      ...
      await refreshCount(); // Rafraîchir le compteur de participants
